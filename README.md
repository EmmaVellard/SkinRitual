...
![Today: a compact day selector and a morning routine](docs/screenshots/today.jpg)
...
![Products grouped by type, with benefits and almost-empty reminders](docs/screenshots/products.jpg)
...
![A product’s benefits and usage, separate from editing](docs/screenshots/product-details.jpg)
...
![History and progress together, with direct access to each day](docs/screenshots/history.jpg)
...
![Advice based on the products already in your cabinet](docs/screenshots/advice.jpg)
...
![Rebuy reminders with a direct product link](docs/screenshots/rebuy.jpg)
...
![French settings with clear preferences and backup controls](docs/screenshots/settings-fr.jpg)
